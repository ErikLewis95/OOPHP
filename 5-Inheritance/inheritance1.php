<!-- script ini akan terjadi error reqrusive karna adanya pemanggilan mentod yang sama dalam 1 class parent Komik dan Game meskipun method {$this->getInfoProduk()} yang dimaksud adalah method yang ada didalam class Parent Produk ada dua cara menanganinya yankni : 1. menggunakan keyword Overriding atau 2. mengganti nama method seperti contoh inheritance2.php 
Overriding sebenarnya merupakan fungsi dari OOPHP untuk menggunakan nama method yang sama dalam 1 clas tapi yang dimaksud adalah mehod parentnya  yang ada di modul berikutnya-->
